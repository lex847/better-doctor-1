...
var displayDoctors = function(medicalIssue, doctors) {
  ...
  if ((doctors.length > 0) && (medicalIssue !== "")) {
    doctors.forEach(function(doctor){
      $('.showDoctors').append("<div class='panel panel-default'><div class='panel-heading'><h4> Dr. " + doctor.profile.first_name + " " + doctor.profile.last_name + "</h4></div><div class='panel-body'> Bio: " + doctor.profile.bio + "</div>");
    });
  } else {
